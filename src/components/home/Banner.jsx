...
const Banner = () => {
  ...
  className="cursor-pointer  w-full h-[460px] 
    rounded-[15px] relative mb-3 overflow-hidden block"
>
  <img
    src="https://i.ibb.co.com/chzBwTyK/Rectangle-206-1.png"
    alt="Top Banner"
...
>
  ...
  <input
    ...
    accept="image/*"
    className="hidden"
    // onChange={handleMiniBannerChange}  
  />
</label>
